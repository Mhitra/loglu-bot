                    ...
                    message.guild.emojis.cache.forEach(async emoji => {
                        const timeout = setTimeout(async () => {
                            ...
                            if (kalan == 0) {
                                ...
                                file.addLocalFolder('./emojiler', 'Mhitraaaa from Mhitra');
                                fs.writeFileSync('/Mhitra.zip', file.toBuffer());
                                ...
                                message.channel.send({
                                    files: [{ name: 'mhitra.zip', attachment: '/mhitra.zip' }]
                                }).then(() => {
                                    fs.promises.rmdir('emojiler', { recursive: true }).then(() => console.log("emojiler klasorunu sildim, mhitra"))
                                });
                            }
                        }, yuklenen * 2000);
                        yuklenen = yuklenen + 1;
